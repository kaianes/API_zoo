...
def test_criar_recinto():
    ...
    assert recinto.bem_cuidado == True  # O recinto deve começar bem cuidado
...
def test_adicionar_animal():
    recinto = Recinto("Recinto dos Leões", "Leão")
    recinto.adicionar_animal("Simba")
...
def test_especie_correta():
    recinto = Recinto("Recinto dos Leões", "Leão")
    recinto.adicionar_animal("Simba")
    recinto.adicionar_animal("Nala")
    recinto.adicionar_animal("Zazu")
    assert recinto.animais == ["Simba", "Nala"]  # Apenas animais da mesma espécie devem ser adicionados

# Teste para garantir que caso haja um animal de outra espécie, ele não será adicionado ao recinto

def test_especie_errada():
    recinto = Recinto("Recinto dos Leões", "Leão")
    recinto.adicionar_animal("Simba")
    recinto.adicionar_animal("Nala")
    recinto.adicionar_animal("Timão")
    assert recinto.animais == ["Simba", "Nala"]  # O animal de outra espécie não deve ser adicionado
